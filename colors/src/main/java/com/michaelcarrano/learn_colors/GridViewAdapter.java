...
public class GridViewAdapter extends BaseAdapter {
    ...
    private ArrayList<ColorsModel> mColors;

    private Activity mContext;

    public GridViewAdapter(Activity ctx, ArrayList<ColorsModel> colors) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.color.setBackgroundColor(Color.parseColor(myColors.hex));
        holder.color.setTextColor(Color.parseColor(myColors.hex));
        holder.color.setText(myColors.name);
